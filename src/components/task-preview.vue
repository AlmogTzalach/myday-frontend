	...
	<section class="task-preview">
		<div class="task-row grid">
			...
			<div class="task-data grid">
				<component v-for="cmp in cmpsOrder" :is="cmp + 'Cmp'" :key="cmp" :task="task" @dataChanged="updateData"
					@statusLabelsEdited="updateStatusLabels" @priorityLabelsEdited="updatePriorityLabels"
					@addStatusLabel="addStatusLabel" @addPriorityLabel="addPriorityLabel"
					@removePriorityLabel="removePriorityLabel" @removeStatusLabel="removeStatusLabel">
				</component>
