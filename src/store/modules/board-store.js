...
export default {
	...
	actions: {
		async addComment({ commit, state }, { txt, loggedUser, taskId, groupId }) {
			const comment = boardService.getEmptyComment(txt, loggedUser)
			commit({ type: 'addComment', comment, taskId, groupId })
